        ...
        child: GetBuilder<LocationController>(builder: (locationController) {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SearchLocationWidget(mapController: _mapController, 
                pickedAddress: locationController.pickAddress, isEnabled: null, fromDialog: true),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                    ...
                    ClipRRect(
                      ...
                      child: GoogleMap(
                        initialCameraPosition: CameraPosition(
                          target: widget.fromAddAddress ? LatLng(locationController.position.latitude, 
          ...
          Stack(children: [
            GoogleMap(
              ...
              minMaxZoomPreference: const MinMaxZoomPreference(0, 26),
              myLocationButtonEnabled: false,
              onMapCreated: (GoogleMapController mapController) {
                _mapController = mapController;
                if(!widget.fromAddAddress) {
